"""
Build unified-wellbeing-data.json and wellbeing-index.json from KUD session files
and criterion-bank-v2.json.
"""
import json
import datetime

CRIT_BANK_PATH = "docs/reference-corpus/real-wellbeing/criterion-bank-v2.json"
UNIFIED_OUT    = "docs/reference-corpus/real-wellbeing/unified-wellbeing-data.json"
INDEX_OUT      = "docs/reference-corpus/real-wellbeing/wellbeing-index.json"
...
KUD["lt_1_2"] = {
    ...
    "bands": {
        ...
        "F": {
            ...
            "do": "The teacher or mentor notices the student recognising when structural or systemic factors are shaping someone's experience, adjusting their response accordingly, and in some cases advocating for a change beyond the individual interaction.",
        },
    },
}
...
T3_LTS = {"lt_1_1", "lt_1_2", "lt_3_2", "lt_5_2", "lt_7_2", "lt_8_3"}
