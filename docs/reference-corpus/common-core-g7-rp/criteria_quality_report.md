...
- **rubrics_total:** 6
- **rubrics_halted_lts:** 2
- **rubrics_with_gate_failures:** 2
- **rubrics_competent_judge_fail:** 0
- **rubrics_propositional_thin_flag:** 2
- **stability_distribution:** rubric_unstable=3, stable=3
...
- **no_inline_examples** — PASS: no inline examples or banned substrings in any descriptor
- **competent_framing_regex** — PASS: Competent descriptor contains no deficit hedge-phrases
- **competent_framing_judge** — PASS: LLM-as-judge verdict: pass — The descriptor declares the capability as demonstrated independently at the LT's level of demand, using no hedging language and standing alone as success.
- **level_progression** — PASS: adjacent levels preserve progression roles
- **propositional_thin_flag** — PASS: verb-bucket diversity across applied levels — no thin flag
...
- **no_inline_examples** — PASS: no inline examples or banned substrings in any descriptor
- **competent_framing_regex** — PASS: Competent descriptor contains no deficit hedge-phrases
- **competent_framing_judge** — PASS: LLM-as-judge verdict: pass — The descriptor declares the capability as demonstrated ('Identifies...accurately') across all required contexts without hedging language, incompleteness framing, or positioning it as a way-station to Extending.
- **level_progression** — PASS: adjacent levels preserve progression roles
...
- **no_inline_examples** — PASS: no inline examples or banned substrings in any descriptor
- **competent_framing_regex** — PASS: Competent descriptor contains no deficit hedge-phrases
- **competent_framing_judge** — PASS: LLM-as-judge verdict: pass — The descriptor declares independent application of proportional relationships to multistep problems with accurate reasoning and justification, which directly matches the LT's demand and stands alone as success without hedging or incompleteness language.
- **level_progression** — PASS: adjacent levels preserve progression roles
- **propositional_thin_flag** — PASS: propositional-thin check skipped (not Type 1)
