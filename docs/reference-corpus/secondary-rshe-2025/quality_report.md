...
- diagnostics:
  - cluster_count_differs: counts across runs = [26, 33, 30]
  - dominant_type_drift_run2: canonical cluster 3 (Type 1) → run2 cluster 3 (Type 2)
- per-cluster stability:
  - `cluster_01` (Marriage, Civil Partnership, and Family Structures): stable — 5 items, dkt=Type 1
  ...
  - `cluster_04` (Addressing Bullying and Ending Relationships): cluster_unstable — 5 items, dkt=Type 1
  - `cluster_05` (Stereotypes, Prejudice, and Power Dynamics): stable — 5 items, dkt=Type 1
  - `cluster_06` (Online Safety and Privacy): stable — 6 items, dkt=Type 1
  - `cluster_07` (Sharing Images and Legal Consequences): stable — 8 items, dkt=Type 1
  - `cluster_08` (Deepfakes, Harmful Content, and Online Harms): stable — 9 items, dkt=Type 1
  - `cluster_09` (Online Scams, Data Privacy, and Emerging Technology Risks): stable — 7 items, dkt=Type 1
  - `cluster_10` (Consent, Boundaries, and Pressure in Relationships): stable — 4 items, dkt=Type 2
  - `cluster_11` (Personal Safety and Recognising Unsafe Relationships): stable — 7 items, dkt=Type 2
  - `cluster_12` (Sexual Harassment, Violence, and Abuse): stable — 7 items, dkt=Type 1
  - `cluster_13` (Harmful Practices and Physical Harms): stable — 5 items, dkt=Type 1
  - `cluster_14` (Healthy Sexual Relationships and Consent): stable — 6 items, dkt=Type 1
  - `cluster_15` (Contraception, Pregnancy Options, and Sexual Health): stable — 10 items, dkt=Type 1
  - `cluster_16` (Emotional Wellbeing and Mental Health Literacy): stable — 8 items, dkt=Type 1
  - `cluster_17` (Substances, Gambling, and Mental Health): stable — 3 items, dkt=Type 1
  - `cluster_18` (Online Wellbeing and Digital Literacy): stable — 13 items, dkt=Type 1
  - `cluster_19` (Diet, Physical Health, and Disease Prevention): stable — 2 items, dkt=Type 1
  - `cluster_20` (Drugs, Alcohol, Tobacco, and Vaping): stable — 6 items, dkt=Type 1
  - `cluster_21` (Infection Prevention, Dental Health, and Screening): stable — 4 items, dkt=Type 1
  - `cluster_22` (Sleep, Reproductive Health, and Accessing Healthcare): stable — 8 items, dkt=Type 1
  - `cluster_23` (Personal Safety, Risk Management, and Peer Influence): stable — 4 items, dkt=Type 2
  - `cluster_24` (Weapons, Exploitation, and Seeking Help): stable — 3 items, dkt=Type 1
  - `cluster_25` (Menstrual and Reproductive Health): stable — 3 items, dkt=Type 1
  - `cluster_26` (First Aid and Emergency Response): stable — 1 items, dkt=Type 1

## Stage: LT generation

- LTs: **66** (halted clusters: 0)
- knowledge-type split: Type 1=44, Type 2=18, Type 3=4
- LT stability: {'stable': 57, 'lt_set_unstable': 9}

## Stage: Type 1/2 band statements

- band sets: **62** (halted LTs: 0)
- stability: {'stable': 52, 'band_statements_unstable': 10}
...
- stability: {'stable': 37, 'rubric_unstable': 18, 'rubric_unreliable': 7}
- rubrics with gate failures: 10
- competent-framing judge: 0 fail
- propositional_lt_rubric_thin_flag: 5
...
- components: **44** (halted LTs: 18)
- stability: {'supporting_unstable': 29, 'stable': 15}
- halted:
  ...
  - `cluster_06_lt_01`: supporting_unreliable — no structural signature reached 2/3 agreement; signatures=[(('stages', 5), ('student_prompts', 5), ('student_rubric_levels', ('no_evidence', 'emerging', 'developing', 'competent', 'extending')), ('self_check_prompts', 3), (('moves', 'no_evidence', 2), ('moves', 'emerging', 2), ('moves', 'developing', 2), ('moves', 'competent', 2))), (('stages', 4), ('student_prompts', 4), ('student_rubric_levels', ('no_evidence', 'emerging', 'developing', 'competent', 'extending')), ('self_check_prompts', 2), (('moves', 'no_evidence', 2), ('moves', 'emerging', 2), ('moves', 'developing', 2), ('moves', 'competent', 2))), (('stages', 5), ('student_prompts', 4), ('student_rubric_levels', ('no_evidence', 'emerging', 'developing', 'competent', 'extending')), ('self_check_prompts', 2), (('moves', 'no_evidence', 2), ('moves', 'emerging', 2), ('moves', 'developing', 2), ('moves', 'competent', 2)))]
  ...
  - `cluster_09_lt_01`: supporting_skipped_gate_fail — rubric has gate failures ['competent_framing_regex']; not a stable anchor for supporting materials
  ...
  - `cluster_18_lt_02`: supporting_skipped_gen_fail — rubric generation failed for cluster_18_lt_02; no content to build from
  - `cluster_20_lt_01`: supporting_skipped_gen_fail — rubric generation failed for cluster_20_lt_01; no content to build from
  - `cluster_24_lt_02`: supporting_skipped_gen_fail — rubric generation failed for cluster_24_lt_02; no content to build from
...
### `competency_clusters` — `cluster_unstable (cluster_count_differs: counts across runs = [26, 33, 30]; dominant_type_drift_run2: canonical cluster 3 (Type 1) → run2 cluster 3 (Type 2))` — **MEDIUM**
...
### `cluster_15_lt_03` — `lt_set_unstable` — **MEDIUM**
...
### `cluster_16_lt_03` — `lt_set_unstable` — **MEDIUM**
...
### `cluster_18_lt_03` — `lt_set_unstable` — **MEDIUM**
...
### `cluster_09_lt_02` — `band_statements_unstable` — **MEDIUM**
...
### `cluster_13_lt_02` — `band_statements_unstable` — **MEDIUM**
...
### `cluster_14_lt_01` — `band_statements_unstable` — **MEDIUM**
...
### `cluster_20_lt_01` — `band_statements_unstable` — **MEDIUM**
...
### `cluster_20_lt_02` — `band_statements_unstable` — **MEDIUM**
...
### `cluster_09_lt_01` — `competent_framing_regex` — **HIGH**
...
### `cluster_10_lt_03` — `gate_unknown` — **MEDIUM**
...
### `cluster_13_lt_01` — `gate_unknown` — **MEDIUM**
...
### `cluster_13_lt_03` — `gate_unknown` — **MEDIUM**
...
### `cluster_14_lt_01` — `single_construct` — **MEDIUM**
...
### `cluster_15_lt_03` — `gate_unknown` — **MEDIUM**
...
### `cluster_22_lt_03` — `gate_unknown` — **MEDIUM**
...
### `cluster_25_lt_03` — `gate_unknown` — **MEDIUM**
...
### `cluster_26_lt_01` — `gate_unknown` — **MEDIUM**
...
### `cluster_18_lt_02` — `rubric_generation_failed` — **MEDIUM**
...
### `cluster_20_lt_01` — `rubric_generation_failed` — **MEDIUM**
...
### `cluster_24_lt_02` — `rubric_generation_failed` — **MEDIUM**
...
### `cluster_06_lt_01` — `supporting_unreliable` — **MEDIUM**
...
### `cluster_13_lt_03` — `supporting_unreliable` — **MEDIUM**
...
### `cluster_22_lt_03` — `supporting_unreliable` — **MEDIUM**
...
### `cluster_18_lt_02` — `supporting_skipped_gen_fail` — **MEDIUM**
...
### `cluster_20_lt_01` — `supporting_skipped_gen_fail` — **MEDIUM**
...
### `cluster_24_lt_02` — `supporting_skipped_gen_fail` — **MEDIUM**
